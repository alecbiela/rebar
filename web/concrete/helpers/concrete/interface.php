...
class ConcreteInterfaceHelper {
	...
	public function submit($text, $formID = false, $buttonAlign = 'right', $innerClass = null, $args = array()) {
		...
		return '<input type="submit" class="btn ccm-button-v2 ' . $innerClass . '" value="' . $text . '" id="ccm-submit-' . $formID . '" name="ccm-submit-' . $formID . '" ' . $buttonAlign . ' ' . $argsstr . ' />';
	}
	...
	public function button_js($text, $onclick, $buttonAlign = 'right', $innerClass = null, $args = array()) {
		...
		return '<input type="button" class="btn ccm-button-v2 ' . $innerClass . '" value="' . $text . '" onclick="' . $onclick . '" ' . $buttonAlign . ' ' . $argsstr . ' />';
	}
